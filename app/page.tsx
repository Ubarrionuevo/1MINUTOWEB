          ...
          <section className="py-12 md:py-16">
            ...
            >
              ...
              <p className="text-center text-gray-400 mb-8 md:mb-12 max-w-2xl mx-auto px-4 text-sm md:text-base">
                Empezá gratis y pagá solo cuando veas resultados
              </p>
                ...
                <div className="max-w-md w-full">
                  <div className="bg-gradient-to-br from-red-500/20 to-red-600/10 rounded-2xl p-6 md:p-8 border border-red-500/50 text-center">
                    <div className="text-center mb-4 md:mb-6">
                      ...
                      <div className="text-3xl md:text-4xl font-bold text-green-500 mb-2">¡GRATIS!</div>
                      <p className="text-gray-400">Para empezar</p>
                      <div className="text-lg text-red-500 font-semibold mt-2">$9.000 ARS/mes después</div>
                    </div>
